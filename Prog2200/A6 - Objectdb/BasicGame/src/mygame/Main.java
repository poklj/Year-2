...
public class Main extends SimpleApplication {
    ...
    ManageJDO jdo = new ManageJDO("VehicleDB.odb");
	...
	*/
        ...
        List<Vehicle> vec = new ArrayList<>();
        List<Object> gfaResult = jdo.getObjects(Vehicle.class);
        
        for(Object obj : gfaResult) {
        	vec.add((Vehicle) obj);
        }
		for(Vehicle v : vec) {
...
//        }
    ...
    public void destroy() {
    	super.destroy();
    	jdo.deleteAllObjects(Vehicle.class);
    	for(Vehicle v: vehicles) {
    		jdo.saveNew(v);
    	}
    }
