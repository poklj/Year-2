...
public class Module_10c_SQLlite {
    ...
    public Module_10c_SQLlite(String db_file_name_prefix) throws Exception {    // note more general exception
    ...
    public void shutdown() throws SQLException {
    	...
    	// no shutdown for SQLlite JDBC interface
...
//                }
    ...
    public static void main(String[] args) {
    	...
    	Module_10c_SQLlite db = null;

        try {
            db = new Module_10c_SQLlite("db_file.sqlite");
        } catch (Exception ex1) {
        ...
        try {
            ...
            db.update(
                    "INSERT INTO sample_table(str_col,num_col) VALUES('RUSS-CO', 200)");
            db.update(
