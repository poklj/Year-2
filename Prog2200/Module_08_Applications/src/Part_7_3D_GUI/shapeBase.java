...
public abstract class shapeBase extends Thread {
	...
	/**
	 * Add the Rotation to the following x, y values
	 * @param dX
	 * @param dY
	 * @param dZ
	 */
	public void BudgeRotation(double dX, double dY, double dZ) {
		rotation_velocity.add(new Pos3D(dX, dY, dZ));
	}

	/**
	 * Add the Translation to the following x, y values
	 * @param dX
	 * @param dY
	 * @param dZ
	 */
	public void BudgeTranslation(double dX, double dY, double dZ) {
		velocity.add(new Pos3D(dX, dY, dZ));
	}
