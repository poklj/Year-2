...
import com.example.russ.m08_net_02.common.NetworkCommand.netCommands;
...
public class ServerHandler extends Thread implements Observer {
	...
	private final Integer serverport = com.example.russ.m08_net_02.common.NetworkAnimal.serverport;
	...
	public void run() {
		...
		while (more) {
			...
			writer.sendThisMsgOnQueue(new NetworkAnimal(NetworkAnimal.Animal.Turtle, rnd(100), rnd(100), rnd(10),
					rnd(10), NetworkAnimal.red, "Russ 1"));

			writer.sendThisMsgOnQueue(new NetworkAnimal(NetworkAnimal.Animal.Turtle, rnd(100), rnd(100), rnd(10),
					rnd(10), NetworkAnimal.blue, "Russ 2"));

			writer.sendThisMsgOnQueue(new NetworkAnimal(NetworkAnimal.Animal.Turtle, rnd(100), rnd(100), rnd(10),
					rnd(10), NetworkAnimal.green, "Russ 3"));

			writer.sendThisMsgOnQueue(new NetworkAnimal(NetworkAnimal.Animal.Turtle, rnd(100), rnd(100), rnd(10),
					rnd(10), NetworkAnimal.purple, "Russ 4"));
	...
	public void update(Observable arg0, Object event) {
		...
		if (event instanceof com.example.russ.m08_net_02.common.NetworkAnimal) {
			com.example.russ.m08_net_02.common.NetworkAnimal e = new com.example.russ.m08_net_02.common.NetworkAnimal(
					(NetworkAnimal) event);
		...
		if (event instanceof com.example.russ.m08_net_02.common.NetworkCommand) {
			com.example.russ.m08_net_02.common.NetworkCommand e = new com.example.russ.m08_net_02.common.NetworkCommand(
