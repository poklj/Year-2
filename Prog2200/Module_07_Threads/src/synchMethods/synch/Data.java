 ...
 * description: class to hold a persons data. 
 */
public class Data {
    ...
    /**
     * Get the string version of the data appended.  We get all one set of data this way.
...
//    public synchronized static String getStaticThreadperson() {
    ...
    /**
     *  Print out the data fields inside this method.  Our way of protecting the
     *  data while writing. 
     */
//        public synchronized static void writeStaticThreadperson() {
            public  static void writeStaticThreadperson() {
