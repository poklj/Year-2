...
public class Cube2 extends Thread {
 ...
 * @param drz
 */
	public Cube2(float x, float y, float z, float dx, float dy, float dz,float rx, float ry, float rz, float drx, float dry, float drz) {
		this.x = x;
		this.y = y;
		this.z = z;
