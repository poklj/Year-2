package com.example.russ.save_v01;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            do {
                in = r.readLine();
                Log.v("SAVED STATE", "onCreate File Read=" + in);
            } while (in != null);
            Log.v("SAVED STATE", "onCreate File Read Done");
            inputStream.close();
        } catch (Exception e) {
            Log.v("SAVED STATE", "onCreate File Read Exception (no file?)");
            e.printStackTrace();
        }
