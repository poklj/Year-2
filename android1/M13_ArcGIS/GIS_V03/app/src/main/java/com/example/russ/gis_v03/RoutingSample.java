...
package com.example.russ.gis_v03;
...
public class RoutingSample extends Activity implements
    ...
    //  <RS> default mLocation to COGS
//	public static Point mLocation = null;
    public static Point mLocation;  //<RS> = new Point(-7254357.351, 5603388.160);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        directionsLabel.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDrawerLayout.openDrawer(GravityCompat.END); // Gravity.END);
        ...
        img_currLocation.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mLocation == null) {
                    mLocation = new Point(44.885, -65.168);
                }
        ...
        map.setOnLongPressListener(new OnLongPressListener() {
            ...
            public boolean onLongPress(final float x, final float y) {
                ...
                Log.v("setOnLongPressListener", "x=" + x + "  y=" + y + "  p=" + p.toString());

                clearAll();


                //<RS> Force 2 points
                Point p1 = new Point(-7254357.351, 5603388.160);
                Point p2 = new Point(-7243386.434, 5612538.158);
    ...
    private void QueryDirections(final Point mLocation, final Point p) {
        ...
        Log.v("ROUTING * * * ", mLocation.toString() + "::" + p.toString());
    ...
    public void onDialogRouteClicked(Point p1, Point p2) {
        ...
        //<RS> Force 2 points
        p1 = new Point(-7254357.351, 5603388.160);
        p2 = new Point(-7243386.434, 5612538.158);
