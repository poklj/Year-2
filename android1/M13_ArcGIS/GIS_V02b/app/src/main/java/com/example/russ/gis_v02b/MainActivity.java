...
package com.example.russ.gis_v02b;
...
/**
 * Sample of ArcGIS:
 *  MapOptions: https://developers.arcgis.com/android/api-reference/reference/com/esri/android/map/MapOptions.html
 *  MapView: https://developers.arcgis.com/android/api-reference/reference/com/esri/android/map/MapView.html
 *
 *  Sample that displays a map using one of 4 baseMaps, selected via menu.
 *
 */
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Force the onCreateOptionsMenu to be called
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        Log.v("onCreateOptionsMenu", "menu: " + menu.toString());
